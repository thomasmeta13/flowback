import React2, { cache } from 'react';
import { SimulatePreloadedQuery } from './index.cc.js';
import { getSuspenseCache, wrapQueryRef } from '@apollo/client/react/internal/index.js';
import { ApolloLink, Observable, InMemoryCache as InMemoryCache$1, gql, ApolloClient as ApolloClient$1 } from '@apollo/client/index.js';
import { hasDirectives, Observable as Observable$1, removeDirectivesFromDocument, print, mergeIncrementalData } from '@apollo/client/utilities/index.js';
...
async function PreloadQuery({
  ...
  return /* @__PURE__ */ React2.createElement(SimulatePreloadedQuery, { queryRef }, typeof children === "function" ? children(queryRef) : children);
}

// src/registerApolloClient.tsx
var seenWrappers = WeakSet ? /* @__PURE__ */ new WeakSet() : undefined;
var seenClients = WeakSet ? /* @__PURE__ */ new WeakSet() : undefined;
var checkForStableCache = cache(() => ({}));
...
function makePreloadQuery(getClient) {
  return function PreloadQuery2(props) {
    return /* @__PURE__ */ React2.createElement(PreloadQuery, { getClient, ...props });
  };
}
...
export { ApolloClient, AccumulateMultipartResponsesLink as DebounceMultipartResponsesLink, InMemoryCache, ReadFromReadableStreamLink, RemoveMultipartDirectivesLink, SSRMultipartLink, TeeToReadableStreamLink, built_for_rsc, createTransportedQueryPreloader, isTransportedQueryRef, readFromReadableStream, registerApolloClient, reviveTransportedQueryRef, teeToReadableStream };
