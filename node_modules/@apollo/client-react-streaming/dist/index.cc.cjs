...
// src/index.cc.tsx
var index_cc_exports = {};
__export(index_cc_exports, {
  SimulatePreloadedQuery: () => SimulatePreloadedQuery
});
module.exports = __toCommonJS(index_cc_exports);
...
var SimulatePreloadedQuery = (props) => {
  if (!RealSimulatePreloadedQuery) {
    RealSimulatePreloadedQuery = React.lazy(
      () => import("./SimulatePreloadedQuery.cc.cjs")
    );
  }
...
//# sourceMappingURL=index.cc.cjs.map